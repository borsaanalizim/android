...
@Database(entities = [StockEntity::class, DateEntity::class, BalanceSheetEntity::class, BalanceSheetRatiosEntity::class], version = 1)
abstract class AppDatabase : RoomDatabase() {
    abstract fun stockDao(): StockDao
    abstract fun financialStatementDao(): BalanceSheetDao
}