...
@Database(entities = [IndexEntity::class, MainCategorySectorEntity::class, SubCategorySectorEntity::class, BalanceSheetDateStockEntity::class, DateEntity::class, StockEntity::class, StockInIndexEntity::class, StockInSectorEntity::class, BalanceSheetStockEntity::class, BalanceSheetEntity::class, BalanceSheetRatioEntity::class], version = 1)
